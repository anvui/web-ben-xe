      ...
      <el-form ref="editForm" :model="editForm" :rules="editRules" class="edit-form" auto-complete="on" label-position="left">
        ...
        <el-form-item prop="username">
          <el-input
            ...
            disabled
          />
          <label class="custom-placeholder">Tên đăng nhập</label>
        </el-form-item>
        ...
        <el-form-item prop="phoneNumber">
          <el-input
            ...
            disabled
          />
          <label class="custom-placeholder">Số điện thoại</label>
        </el-form-item>
        ...
        <el-form-item prop="fullname">
          <el-input
            ...
            tabindex="3"
          />
          <label class="custom-placeholder">Họ tên</label>
        </el-form-item>
  ...
  data() {
    const validateUsername = (rule, value, callback) => {
      ...
      if (value.length < 6 || value.length > 20) {
        callback(new Error('Vui lòng nhập tên đăng nhập trong khoảng từ 6-20 ký tự'))
      } else if (regWhiteSpace.test(value)) {
        callback(new Error('Tên đăng nhập không được chứa khoảng trắng'))
      } else {
        callback()
      }
    }
    const validateFullname = (rule, value, callback) => {
      ...
      if (value.length <= 0 || !reg.test(value)) {
        callback(new Error('Nhập đúng định dạng họ tên'))
      } else {
        callback()
      }
    }
    const validatePhoneNumber = (rule, value, callback) => {
      ...
      if (value.length <= 0 || !reg.test(value)) {
        callback(new Error('Nhập đúng định dạng số điện thoại'))
      } else {
        callback()
      }
    }
