<template>
  <div class="app-customer">
    <el-dialog
      ...
      width="90%"
    >
      <h4 class="title">{{ $t('downloadApp.appPartner.title') }}</h4>
      <div class="row no-gutters align-items-center">
        <div class="col-auto">
          <img
            src="https://apikbus.anvui.vn/image/get/8f4cce80-1678-470b-bd0c-0f4747cf0e1e"
            alt="logo kbus"
            class="logo"
      ...
      <el-button v-if="platform === 'IOS'" class="btn-get-app" @click="handleDownloadApp(appType.APP_IOS_FOR_DRIVER)">
        <img src="@/assets/images/icon-apple.svg" alt="icon google play" width="24" height="24">
        <span>{{ $t('downloadApp.button.ios') }}</span>
      </el-button>
      <el-button v-if="platform === 'ANDROID'" class="btn-get-app" @click="handleDownloadApp(appType.APP_ANDROID_FOR_DRIVER)">
